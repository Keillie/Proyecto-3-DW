...
![diagrama](src\assets\diagramadb.jpg)
...
![diagrama](src\assets\alojamiento.jpg)
...
![diagrama](src\assets\tablas.jpg)
#### Tabla de Departamento
![departamento](src\assets\departamento.jpg)
#### Tabla de Usuario y Empleado
![usuarioempleado](src\assets\usuarioempleado.jpg)
#### Tabla de Historial_emp
![diagrama](src\assets\historialemp.jpg)
### **VPN con OpenVPN**
#### Nos registramos en OpenVPN el cual nos brinda el servicio para poder realizar conexión máxima de 3 usuarios. 
![diagrama](src\assets\OPENVPN.jpg)
...
![diagrama](src\assets\usuariosvpn.jpg)
...
![diagrama](src\assets\conexion.jpg)
...
![diagrama](src\assets\enlinea.jpg)
...
![diagrama](src\assets\firabase.jpg)
### **Conclusiones**
